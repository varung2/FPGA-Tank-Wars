...
module lab7_soc_mm_interconnect_0 (
	...
	wire          cmd_mux_008_src_valid;                                                              // cmd_mux_008:src_valid -> accumulate_s1_agent:cp_valid
	wire  [106:0] cmd_mux_008_src_data;                                                               // cmd_mux_008:src_data -> accumulate_s1_agent:cp_data
	wire          cmd_mux_008_src_ready;                                                              // accumulate_s1_agent:cp_ready -> cmd_mux_008:src_ready
	wire    [8:0] cmd_mux_008_src_channel;                                                            // cmd_mux_008:src_channel -> accumulate_s1_agent:cp_channel
	wire          cmd_mux_008_src_startofpacket;                                                      // cmd_mux_008:src_startofpacket -> accumulate_s1_agent:cp_startofpacket
	wire          cmd_mux_008_src_endofpacket;                                                        // cmd_mux_008:src_endofpacket -> accumulate_s1_agent:cp_endofpacket
	...
	wire          accumulate_s1_agent_rp_valid;                                                       // accumulate_s1_agent:rp_valid -> router_010:sink_valid
	wire  [106:0] accumulate_s1_agent_rp_data;                                                        // accumulate_s1_agent:rp_data -> router_010:sink_data
	wire          accumulate_s1_agent_rp_ready;                                                       // router_010:sink_ready -> accumulate_s1_agent:rp_ready
	wire          accumulate_s1_agent_rp_startofpacket;                                               // accumulate_s1_agent:rp_startofpacket -> router_010:sink_startofpacket
	wire          accumulate_s1_agent_rp_endofpacket;                                                 // accumulate_s1_agent:rp_endofpacket -> router_010:sink_endofpacket
	...
	wire          accumulate_s1_agent_rdata_fifo_src_valid;                                           // accumulate_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_008:in_0_valid
	wire   [33:0] accumulate_s1_agent_rdata_fifo_src_data;                                            // accumulate_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_008:in_0_data
	wire          accumulate_s1_agent_rdata_fifo_src_ready;                                           // avalon_st_adapter_008:in_0_ready -> accumulate_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_008_out_0_valid;                                                  // avalon_st_adapter_008:out_0_valid -> accumulate_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_008_out_0_data;                                                   // avalon_st_adapter_008:out_0_data -> accumulate_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_008_out_0_ready;                                                  // accumulate_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_008:out_0_ready
	wire    [0:0] avalon_st_adapter_008_out_0_error;                                                  // avalon_st_adapter_008:out_0_error -> accumulate_s1_agent:rdata_fifo_sink_error
